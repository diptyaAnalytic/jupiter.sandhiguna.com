...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 11.0.0 20210225 (Red Hat 11.0.0-0)'
...
grub_target_cppflags='-I/builddir/build/BUILD/grub-2.06~rc1/grub-i386-pc-2.06~rc1 -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/i686-redhat-linux/11/include -I$(top_srcdir)/include -I$(top_builddir)/include'
...
# Version
grub_version="2.06~rc1"
grub_package="grub"
grub_package_string="GRUB 2.06~rc1"
grub_package_version="2.06~rc1"
