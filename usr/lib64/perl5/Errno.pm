...
"x86_64-linux-thread-multi-5.16.8-200.fc35.x86_64" or
	die "Errno architecture (x86_64-linux-thread-multi-5.16.8-200.fc35.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
