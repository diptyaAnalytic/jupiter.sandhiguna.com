...
class ConfigMain(Config):
    ...
    def exclude_from_weak(self):
        return _conf.ConfigMain_exclude_from_weak(self)

    def exclude_from_weak_autodetect(self):
        return _conf.ConfigMain_exclude_from_weak_autodetect(self)
