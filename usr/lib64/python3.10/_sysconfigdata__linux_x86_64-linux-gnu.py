...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -shared -Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    -g  '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DDYNAMIC_ANNOTATIONS_ENABLED=1 '
           ...
           '-fwrapv -O2  -fexceptions -g -grecord-gcc-switches -pipe -Wall '
           '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
           '-Wp,-D_GLIBCXX_ASSERTIONS  -fstack-protector-strong   -m64  '
           '-mtune=generic -fasynchronous-unwind-tables '
           '-fstack-clash-protection -fcf-protection -D_GNU_SOURCE -fPIC '
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-O2  -fexceptions -g -grecord-gcc-switches -pipe -Wall '
                     '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                     '-Wp,-D_GLIBCXX_ASSERTIONS  -fstack-protector-strong   '
                     '-m64  -mtune=generic -fasynchronous-unwind-tables '
                     '-fstack-clash-protection -fcf-protection -D_GNU_SOURCE '
                     '-fPIC -fwrapv',
 'CONFIGURE_CFLAGS_NODIST': '-O2 -flto=auto -ffat-lto-objects -fexceptions -g '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    -g',
 'CONFIGURE_LDFLAGS_NODIST': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now '
                             '-specs=/usr/lib/rpm/redhat/redhat-hardened-ld '
                             '-specs=/usr/lib/rpm/redhat/redhat-annobin-cc1  '
                             '-g  -fno-semantic-interposition -flto '
                             '-fuse-linker-plugin -ffat-lto-objects '
 ...
 'CONFIG_ARGS': "'--build=x86_64-redhat-linux-gnu' "
                ...
                "'--with-platlibdir=lib64' '--enable-ipv6' '--enable-shared' "
                ...
                "'--with-lto' '--with-ssl-default-suites=openssl' "
                "'--without-static-libpython' "
                "'--with-wheel-pkg-dir=/usr/share/python-wheels' "
                "'--with-valgrind' '--without-ensurepip' "
                ...
                '-mtune=generic -fasynchronous-unwind-tables '
                '-fstack-clash-protection -fcf-protection -D_GNU_SOURCE -fPIC '
                "-fwrapv ' 'LDFLAGS= -Wl,-z,relro -Wl,--as-needed  "
                "-Wl,-z,now    -g ' 'CPPFLAGS=' "
                "'PKG_CONFIG_PATH=:/usr/lib64/pkgconfig:/usr/share/pkgconfig'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/builddir/build/BUILD/Python-3.10.8/build/optimized/coverage.info',
 'COVERAGE_REPORT': '/builddir/build/BUILD/Python-3.10.8/build/optimized/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/builddir/build/BUILD/Python-3.10.8/Include',
 'CXX': 'g++',
 'DESTDIRS': '/usr /usr/lib64 /usr/lib64/python3.10 '
 ...
 'LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    -g  -Wl,-z,relro '
            '-Wl,--as-needed  -Wl,-z,now    -g',
 'LDLIBRARY': 'libpython3.10.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    -g  '
             '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    -g',
 'LDVERSION': '3.10',
 'LIBC': '',
 ...
 'MAKESETUP': '/builddir/build/BUILD/Python-3.10.8/Modules/makesetup',
 ...
 'OPENSSL_RPATH': '',
 'OPT': '-DDYNAMIC_ANNOTATIONS_ENABLED=1 -DNDEBUG  -O2  -fexceptions -g '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             '-DDYNAMIC_ANNOTATIONS_ENABLED=1 -DNDEBUG  -O2  '
                             ...
                             '-fasynchronous-unwind-tables '
                             '-fstack-clash-protection -fcf-protection '
                             '-D_GNU_SOURCE -fPIC -fwrapv  -O2  -fexceptions '
                             '-g -grecord-gcc-switches -pipe -Wall '
                             '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                             '-Wp,-D_GLIBCXX_ASSERTIONS  '
                             '-fstack-protector-strong   -m64  -mtune=generic '
                             '-fasynchronous-unwind-tables '
                             '-fstack-clash-protection -fcf-protection '
                             '-D_GNU_SOURCE -fPIC -fwrapv -O2 -flto=auto '
                             '-ffat-lto-objects -fexceptions -g '
                             '-grecord-gcc-switches -pipe -Wall '
                             '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                             '-Wp,-D_GLIBCXX_ASSERTIONS '
                             '-specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 '
                             ...
                             '-Wno-missing-field-initializers '
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden -O2 -flto=auto '
                             '-ffat-lto-objects -fexceptions -g '
                             '-grecord-gcc-switches -pipe -Wall '
                             '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                             '-Wp,-D_GLIBCXX_ASSERTIONS '
                             ...
                             '-fprofile-correction '
                             '-I/builddir/build/BUILD/Python-3.10.8/Include/internal '
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare '
              ...
              '-fcf-protection -D_GNU_SOURCE -fPIC -fwrapv -O2  -fexceptions '
 ...
 'PY_CFLAGS_NODIST': '-O2 -flto=auto -ffat-lto-objects -fexceptions -g '
                     '-grecord-gcc-switches -pipe -Wall '
                     '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                     '-Wp,-D_GLIBCXX_ASSERTIONS '
                     '-specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 '
                     ...
                     '-Wno-missing-field-initializers '
                     '-Werror=implicit-function-declaration '
                     '-fvisibility=hidden -O2 -flto=auto -ffat-lto-objects '
                     '-fexceptions -g -grecord-gcc-switches -pipe -Wall '
                     '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                     '-Wp,-D_GLIBCXX_ASSERTIONS '
                     '-specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                   ...
                   '-m64  -mtune=generic -fasynchronous-unwind-tables '
                   '-fstack-clash-protection -fcf-protection -D_GNU_SOURCE '
                   '-fPIC -fwrapv -O2  -fexceptions -g -grecord-gcc-switches '
                   '-pipe -Wall -Werror=format-security '
                   '-Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS  '
                   '-fstack-protector-strong   -m64  -mtune=generic '
                   '-fasynchronous-unwind-tables -fstack-clash-protection '
                   '-fcf-protection -D_GNU_SOURCE -fPIC -fwrapv  -O2  '
                   '-fexceptions -g -grecord-gcc-switches -pipe -Wall '
                   '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                   '-Wp,-D_GLIBCXX_ASSERTIONS  -fstack-protector-strong   '
                   '-m64  -mtune=generic -fasynchronous-unwind-tables '
                   '-fstack-clash-protection -fcf-protection -D_GNU_SOURCE '
                   '-fPIC -fwrapv -O2 -flto=auto -ffat-lto-objects '
                   '-fexceptions -g -grecord-gcc-switches -pipe -Wall '
                   '-Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 '
                   '-Wp,-D_GLIBCXX_ASSERTIONS '
                   '-specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 '
                   ...
                   '-I/builddir/build/BUILD/Python-3.10.8/Include/internal '
                   '-IObjects -IInclude -IPython -I. '
                   '-I/builddir/build/BUILD/Python-3.10.8/Include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    -g  '
                    '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    -g '
                    '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now '
                    '-specs=/usr/lib/rpm/redhat/redhat-hardened-ld '
                    '-specs=/usr/lib/rpm/redhat/redhat-annobin-cc1  -g  '
 ...
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now    -g  -Wl,-z,relro '
               '-Wl,--as-needed  -Wl,-z,now    -g',
 'PY_LDFLAGS_NODIST': '-Wl,-z,relro -Wl,--as-needed  -Wl,-z,now '
                      '-specs=/usr/lib/rpm/redhat/redhat-hardened-ld '
                      '-specs=/usr/lib/rpm/redhat/redhat-annobin-cc1  -g  '
                      '-fno-semantic-interposition -flto -fuse-linker-plugin '
                      '-ffat-lto-objects -flto-partition=none -g -Wl,-z,relro '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.10.8/build/optimized',
 'SCRIPTDIR': '/usr/lib64',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'SRC_GDB_HOOKS': '/builddir/build/BUILD/Python-3.10.8/Tools/gdb/libpython.py',
 'STATIC_LIBPYTHON': 0,
 'STDC_HEADERS': 1,
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.10.8/build/optimized '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.10.8/build/optimized '
               './python '
               '/builddir/build/BUILD/Python-3.10.8/Tools/scripts/run_tests.py',
 ...
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': '/builddir/build/BUILD/Python-3.10.8/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 1,
 'VERSION': '3.10',
 'VPATH': '/builddir/build/BUILD/Python-3.10.8',
 ...
 'abs_builddir': '/builddir/build/BUILD/Python-3.10.8/build/optimized',
 'abs_srcdir': '/builddir/build/BUILD/Python-3.10.8',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'prefix': '/usr',
 'srcdir': '/builddir/build/BUILD/Python-3.10.8'}
