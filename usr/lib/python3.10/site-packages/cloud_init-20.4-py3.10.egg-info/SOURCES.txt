...
cloudinit/sources/helpers/vmware/imc/ipv4_mode.py
...
doc/examples/cloud-config-salt-minion.txt
doc/examples/cloud-config-seed-random.txt
...
doc/examples/upstart-cloud-config.txt
doc/examples/upstart-rclocal.txt
...
doc/rtd/topics/integration_tests.rst
doc/rtd/topics/logging.rst
doc/rtd/topics/merging.rst
doc/rtd/topics/modules.rst
doc/rtd/topics/network-config-format-eni.rst
doc/rtd/topics/network-config-format-v1.rst
doc/rtd/topics/network-config-format-v2.rst
doc/rtd/topics/network-config.rst
doc/rtd/topics/security.rst
doc/rtd/topics/vendordata.rst
doc/rtd/topics/datasources/aliyun.rst
doc/rtd/topics/datasources/altcloud.rst
doc/rtd/topics/datasources/azure.rst
doc/rtd/topics/datasources/cloudsigma.rst
doc/rtd/topics/datasources/cloudstack.rst
doc/rtd/topics/datasources/configdrive.rst
doc/rtd/topics/datasources/digitalocean.rst
doc/rtd/topics/datasources/e24cloud.rst
doc/rtd/topics/datasources/ec2.rst
doc/rtd/topics/datasources/exoscale.rst
doc/rtd/topics/datasources/fallback.rst
doc/rtd/topics/datasources/gce.rst
doc/rtd/topics/datasources/maas.rst
doc/rtd/topics/datasources/nocloud.rst
doc/rtd/topics/datasources/opennebula.rst
doc/rtd/topics/datasources/openstack.rst
doc/rtd/topics/datasources/oracle.rst
doc/rtd/topics/datasources/ovf.rst
doc/rtd/topics/datasources/rbxcloud.rst
doc/rtd/topics/datasources/smartos.rst
doc/rtd/topics/datasources/zstack.rst
doc/sources/kernel-cmdline.txt
...
packages/debian/cloud-init.postinst
packages/debian/cloud-init.preinst
...
sysvinit/redhat/cloud-config
sysvinit/redhat/cloud-final
sysvinit/redhat/cloud-init
sysvinit/redhat/cloud-init-local
sysvinit/suse/cloud-config
sysvinit/suse/cloud-final
sysvinit/suse/cloud-init
sysvinit/suse/cloud-init-local
...
tests/cloud_tests/__main__.py
tests/cloud_tests/args.py
tests/cloud_tests/bddeb.py
tests/cloud_tests/collect.py
tests/cloud_tests/config.py
tests/cloud_tests/manage.py
tests/cloud_tests/platforms.yaml
tests/cloud_tests/releases.yaml
tests/cloud_tests/run_funcs.py
tests/cloud_tests/setup_image.py
tests/cloud_tests/stage.py
tests/cloud_tests/testcases.yaml
...
tests/cloud_tests/platforms/azurecloud/__init__.py
...
tests/cloud_tests/platforms/azurecloud/regions.json
tests/cloud_tests/platforms/azurecloud/snapshot.py
tests/cloud_tests/platforms/ec2/__init__.py
tests/cloud_tests/platforms/ec2/image.py
tests/cloud_tests/platforms/ec2/instance.py
tests/cloud_tests/platforms/ec2/platform.py
tests/cloud_tests/platforms/ec2/snapshot.py
tests/cloud_tests/platforms/lxd/__init__.py
tests/cloud_tests/platforms/lxd/image.py
tests/cloud_tests/platforms/lxd/instance.py
tests/cloud_tests/platforms/lxd/platform.py
tests/cloud_tests/platforms/lxd/snapshot.py
tests/cloud_tests/platforms/nocloudkvm/__init__.py
...
tests/cloud_tests/platforms/nocloudkvm/snapshot.py
tests/cloud_tests/testcases/__init__.py
tests/cloud_tests/testcases/base.py
tests/cloud_tests/testcases/bugs/README.md
tests/cloud_tests/testcases/bugs/__init__.py
tests/cloud_tests/testcases/bugs/lp1511485.py
tests/cloud_tests/testcases/bugs/lp1511485.yaml
tests/cloud_tests/testcases/bugs/lp1611074.yaml
tests/cloud_tests/testcases/bugs/lp1628337.py
tests/cloud_tests/testcases/bugs/lp1628337.yaml
tests/cloud_tests/testcases/examples/README.md
tests/cloud_tests/testcases/examples/TODO.md
tests/cloud_tests/testcases/examples/__init__.py
tests/cloud_tests/testcases/examples/add_apt_repositories.py
tests/cloud_tests/testcases/examples/add_apt_repositories.yaml
tests/cloud_tests/testcases/examples/alter_completion_message.py
tests/cloud_tests/testcases/examples/alter_completion_message.yaml
tests/cloud_tests/testcases/examples/configure_instance_trusted_ca_certificates.py
tests/cloud_tests/testcases/examples/configure_instance_trusted_ca_certificates.yaml
tests/cloud_tests/testcases/examples/configure_instances_ssh_keys.py
tests/cloud_tests/testcases/examples/configure_instances_ssh_keys.yaml
tests/cloud_tests/testcases/examples/including_user_groups.py
tests/cloud_tests/testcases/examples/including_user_groups.yaml
tests/cloud_tests/testcases/examples/install_arbitrary_packages.py
tests/cloud_tests/testcases/examples/install_arbitrary_packages.yaml
tests/cloud_tests/testcases/examples/install_run_chef_recipes.py
tests/cloud_tests/testcases/examples/install_run_chef_recipes.yaml
tests/cloud_tests/testcases/examples/run_apt_upgrade.py
tests/cloud_tests/testcases/examples/run_apt_upgrade.yaml
tests/cloud_tests/testcases/examples/run_commands.py
tests/cloud_tests/testcases/examples/run_commands.yaml
tests/cloud_tests/testcases/examples/run_commands_first_boot.py
tests/cloud_tests/testcases/examples/run_commands_first_boot.yaml
tests/cloud_tests/testcases/examples/setup_run_puppet.yaml
tests/cloud_tests/testcases/examples/writing_out_arbitrary_files.py
tests/cloud_tests/testcases/examples/writing_out_arbitrary_files.yaml
tests/cloud_tests/testcases/main/README.md
tests/cloud_tests/testcases/main/__init__.py
tests/cloud_tests/testcases/main/command_output_simple.py
tests/cloud_tests/testcases/main/command_output_simple.yaml
tests/cloud_tests/testcases/modules/README.md
tests/cloud_tests/testcases/modules/TODO.md
tests/cloud_tests/testcases/modules/__init__.py
tests/cloud_tests/testcases/modules/apt_configure_conf.py
tests/cloud_tests/testcases/modules/apt_configure_conf.yaml
tests/cloud_tests/testcases/modules/apt_configure_disable_suites.py
tests/cloud_tests/testcases/modules/apt_configure_disable_suites.yaml
tests/cloud_tests/testcases/modules/apt_configure_primary.py
tests/cloud_tests/testcases/modules/apt_configure_primary.yaml
tests/cloud_tests/testcases/modules/apt_configure_proxy.py
tests/cloud_tests/testcases/modules/apt_configure_proxy.yaml
tests/cloud_tests/testcases/modules/apt_configure_security.py
tests/cloud_tests/testcases/modules/apt_configure_security.yaml
tests/cloud_tests/testcases/modules/apt_configure_sources_key.py
tests/cloud_tests/testcases/modules/apt_configure_sources_key.yaml
tests/cloud_tests/testcases/modules/apt_configure_sources_keyserver.py
tests/cloud_tests/testcases/modules/apt_configure_sources_keyserver.yaml
tests/cloud_tests/testcases/modules/apt_configure_sources_list.py
...
tests/cloud_tests/testcases/modules/apt_configure_sources_ppa.yaml
tests/cloud_tests/testcases/modules/apt_pipelining_disable.py
tests/cloud_tests/testcases/modules/apt_pipelining_disable.yaml
tests/cloud_tests/testcases/modules/apt_pipelining_os.py
tests/cloud_tests/testcases/modules/apt_pipelining_os.yaml
tests/cloud_tests/testcases/modules/bootcmd.py
tests/cloud_tests/testcases/modules/bootcmd.yaml
tests/cloud_tests/testcases/modules/byobu.py
tests/cloud_tests/testcases/modules/byobu.yaml
tests/cloud_tests/testcases/modules/ca_certs.py
tests/cloud_tests/testcases/modules/ca_certs.yaml
tests/cloud_tests/testcases/modules/debug_disable.py
tests/cloud_tests/testcases/modules/debug_disable.yaml
tests/cloud_tests/testcases/modules/debug_enable.py
tests/cloud_tests/testcases/modules/debug_enable.yaml
tests/cloud_tests/testcases/modules/final_message.py
tests/cloud_tests/testcases/modules/final_message.yaml
tests/cloud_tests/testcases/modules/keys_to_console.py
tests/cloud_tests/testcases/modules/keys_to_console.yaml
tests/cloud_tests/testcases/modules/landscape.yaml
tests/cloud_tests/testcases/modules/locale.py
tests/cloud_tests/testcases/modules/locale.yaml
tests/cloud_tests/testcases/modules/lxd_bridge.py
tests/cloud_tests/testcases/modules/lxd_bridge.yaml
tests/cloud_tests/testcases/modules/lxd_dir.py
tests/cloud_tests/testcases/modules/lxd_dir.yaml
tests/cloud_tests/testcases/modules/ntp.py
tests/cloud_tests/testcases/modules/ntp.yaml
tests/cloud_tests/testcases/modules/ntp_chrony.py
tests/cloud_tests/testcases/modules/ntp_chrony.yaml
tests/cloud_tests/testcases/modules/ntp_pools.py
tests/cloud_tests/testcases/modules/ntp_pools.yaml
tests/cloud_tests/testcases/modules/ntp_servers.py
tests/cloud_tests/testcases/modules/ntp_servers.yaml
tests/cloud_tests/testcases/modules/ntp_timesyncd.py
tests/cloud_tests/testcases/modules/ntp_timesyncd.yaml
tests/cloud_tests/testcases/modules/package_update_upgrade_install.py
tests/cloud_tests/testcases/modules/package_update_upgrade_install.yaml
tests/cloud_tests/testcases/modules/runcmd.py
tests/cloud_tests/testcases/modules/runcmd.yaml
tests/cloud_tests/testcases/modules/seed_random_command.yaml
tests/cloud_tests/testcases/modules/seed_random_data.py
tests/cloud_tests/testcases/modules/seed_random_data.yaml
tests/cloud_tests/testcases/modules/set_hostname.py
tests/cloud_tests/testcases/modules/set_hostname.yaml
tests/cloud_tests/testcases/modules/set_hostname_fqdn.py
tests/cloud_tests/testcases/modules/set_hostname_fqdn.yaml
tests/cloud_tests/testcases/modules/set_password.py
tests/cloud_tests/testcases/modules/set_password.yaml
tests/cloud_tests/testcases/modules/set_password_expire.py
tests/cloud_tests/testcases/modules/set_password_expire.yaml
tests/cloud_tests/testcases/modules/set_password_list.py
tests/cloud_tests/testcases/modules/set_password_list.yaml
tests/cloud_tests/testcases/modules/set_password_list_string.py
tests/cloud_tests/testcases/modules/set_password_list_string.yaml
tests/cloud_tests/testcases/modules/snap.py
...
tests/cloud_tests/testcases/modules/ssh_auth_key_fingerprints_enable.py
tests/cloud_tests/testcases/modules/ssh_auth_key_fingerprints_enable.yaml
tests/cloud_tests/testcases/modules/ssh_import_id.py
...
tests/cloud_tests/testcases/modules/ssh_keys_provided.py
tests/cloud_tests/testcases/modules/ssh_keys_provided.yaml
tests/cloud_tests/testcases/modules/timezone.py
tests/cloud_tests/testcases/modules/timezone.yaml
tests/cloud_tests/testcases/modules/user_groups.py
tests/cloud_tests/testcases/modules/user_groups.yaml
tests/cloud_tests/testcases/modules/write_files.py
...
tests/integration_tests/bugs/test_lp1900837.py
tests/integration_tests/modules/test_apt_configure_sources_list.py
...
tests/integration_tests/modules/test_runcmd.py
tests/integration_tests/modules/test_seed_random_data.py
tests/integration_tests/modules/test_set_hostname.py
tests/integration_tests/modules/test_set_password.py
tests/integration_tests/modules/test_snap.py
...
tests/integration_tests/modules/test_timezone.py
...
tests/unittests/test_datasource/__init__.py
...
tests/unittests/test_datasource/test_common.py
tests/unittests/test_datasource/test_configdrive.py
tests/unittests/test_datasource/test_digitalocean.py
...
tests/unittests/test_distros/__init__.py
tests/unittests/test_distros/test_arch.py
...
tests/unittests/test_distros/test_gentoo.py
tests/unittests/test_distros/test_hostname.py
tests/unittests/test_distros/test_hosts.py
tests/unittests/test_distros/test_netbsd.py
tests/unittests/test_distros/test_netconfig.py
tests/unittests/test_distros/test_opensuse.py
tests/unittests/test_distros/test_resolv.py
tests/unittests/test_distros/test_sles.py
tests/unittests/test_distros/test_sysconfig.py
tests/unittests/test_distros/test_user_data_normalize.py
tests/unittests/test_filters/__init__.py
tests/unittests/test_filters/test_launch_index.py
tests/unittests/test_handler/__init__.py
tests/unittests/test_handler/test_handler_apk_configure.py
tests/unittests/test_handler/test_handler_apt_conf_v1.py
...
tests/unittests/test_handler/test_handler_refresh_rmc_and_interface.py
tests/unittests/test_handler/test_handler_resizefs.py
tests/unittests/test_handler/test_handler_rsyslog.py
...
tests/unittests/test_vmware/__init__.py
tests/unittests/test_vmware/test_custom_script.py
...
upstart/cloud-init-blocknet.conf
upstart/cloud-init-container.conf
